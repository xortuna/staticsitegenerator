...
Anything HTML will be copied into its relative directory inside the output folder (_www/) so legal/eula.html will become _www/legal/eula.html.
...
each code block creates a new layer thst is popped when the block ends
